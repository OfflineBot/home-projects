	...
	return []capability.Action{
		{
			...
			Fields: []capability.AccountField{
				{Name: "method", Label: "Method", Type: "select", Options: []capability.Option{
					{Value: "", Label: "GET"}, {Value: "POST", Label: "POST"}, {Value: "PUT", Label: "PUT"},
					{Value: "PATCH", Label: "PATCH"}, {Value: "DELETE", Label: "DELETE"}, {Value: "HEAD", Label: "HEAD"},
				}},
				{Name: "url", Label: "Address", Type: "list", Required: true, Placeholder: "https://…"},
				{Name: "headers", Label: "Headers", Type: "textarea", Placeholder: "Content-Type: application/json"},
				{Name: "body", Label: "Body", Type: "textarea",
					Hint: "For a WLED this is where its own JSON goes: {\"seg\":[{\"fx\":66}]}"},
				{Name: "timeout", Label: "Timeout", Type: "number", Placeholder: "seconds"},
				{Name: "expect", Label: "Expect this status", Type: "number", Placeholder: "200"},
			},
			Run: runHTTP,
		},
		{
			...
			Fields: []capability.AccountField{
				{Name: "mac", Label: "MAC", Type: "text", Required: true, Placeholder: "aa:bb:cc:dd:ee:ff"},
				{Name: "broadcast", Label: "Broadcast address", Type: "text", Placeholder: "192.168.178.255"},
				{Name: "port", Label: "Port", Type: "number", Placeholder: "9"},
			},
			Run: runWOL,
		},
		{
			...
			Fields: []capability.AccountField{
				{Name: "account", Label: "Machine account", Type: "select", From: "accounts:machine"},
				{Name: "host", Label: "…or address", Type: "text", Placeholder: "192.168.178.50",
					Show: "!account"},
				{Name: "port", Label: "Port", Type: "number", Placeholder: "22", Show: "!account"},
				{Name: "user", Label: "User", Type: "text", Show: "!account"},
		...
		},
		{
			...
			Fields: []capability.AccountField{
				{Name: "account", Label: "Which lights", Type: "select", From: "accounts:wled",
					Hint: "A light account holds several lamps and is switched as one."},
				{Name: "host", Label: "…or addresses", Type: "list", Placeholder: "192.168.178.60",
					Show: "!account"},
				{Name: "power", Label: "Power", Type: "select", Options: []capability.Option{
					{Value: "", Label: "leave as it is"},
					{Value: "on", Label: "on"},
					{Value: "off", Label: "off"},
					{Value: "toggle", Label: "the other one"},
				}},
				{Name: "brightness", Label: "Brightness", Type: "number", Placeholder: "0–255",
					Show: "power!=off"},
				{Name: "color", Label: "Colour", Type: "color", Show: "power!=off"},
				{Name: "effect", Label: "Effect", Type: "select", From: "wled:effects", Show: "power!=off"},
				{Name: "preset", Label: "Preset", Type: "number", Show: "power!=off",
					Hint: "A preset saved on the lamp itself."},
			},
			Run: runWLED,
		},
		{
			...
			Fields: []capability.AccountField{
				...
				{Name: "variable", Label: "Write the answer into", Type: "text", Placeholder: "online"},
			},
			Run: runPing,
		},
		{
